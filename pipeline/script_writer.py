...
def _build_script_prompt(topic: dict) -> str:
    return (
        ...
        "commonly-and-correctly-photographed concepts (oceans, brains, lightning, a generic "
        "starry night sky, common animals like dogs/lions/eagles, generic lab equipment) that "
        "stock libraries reliably have accurate matches for. 'Space' is NOT one of these on its "
        "own — a specific planet, moon, storm system, or named astronomical feature (e.g. "
        "Jupiter's Great Red Spot, Saturn's rings, a specific nebula) is not something an "
        "ordinary photographer could go photograph either, so treat it like the deep-sea case "
        "above and default to true.\n"
